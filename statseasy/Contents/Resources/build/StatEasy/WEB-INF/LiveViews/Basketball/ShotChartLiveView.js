...
function ShotChartLiveView(myTargetDivId, dataManager) {
	...
	var image = {
		url : '/images/BasketballCourt.gif',
		height : 940,
		width : 500,
		object : undefined,
	};
	...
	function show() {
		...
		if (!self.shown) {
			...
			$("#" + self.targetDivId).append("<audio  id='" + self.targetDivId + "_audio' preload='auto'><source src='/images/alert.oga' type='audio/ogg'/><source src='/StatEasy/images/alert.mp3' type='audio/mpeg'/></audio>");
