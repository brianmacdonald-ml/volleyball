...
var statEffectName = "Add Player & Point";
...
function execute() {
	...
	for (var i = 0; i < allPlayers.size(); i++) {
		...
		if (relevantPlayerId == playerInSeason.player.id) {
			...
			relevantStat.setDataAtIndex(1, whoHitItData);
...
var statType = {
	name:         statEffectName,
	friendlyName: "Awards a Point & Adds data to a statistic: Which player hit the ball",
	version:      3.2,
	execute:      execute,
	provides:     "%sep",
};